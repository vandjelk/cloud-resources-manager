...
// +kubebuilder:validation:XValidation:rule="has(self.remotePrivateDnsZone) != has(self.remoteDnsPrivateResolverRuleset)", message="Exactly one of RemotePrivateDnsZone or RemoteDnsPrivateResolverRuleset must be specified"
type AzureVpcDnsLinkSpec struct {
	...
	// +kubebuilder:validation:XValidation:rule=(self == oldSelf), message="RemoteDnsPrivateResolverRuleset is immutable."
	RemoteDnsPrivateResolverRuleset string `json:"remoteDnsPrivateResolverRuleset,omitempty"`
