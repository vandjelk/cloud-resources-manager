...
func TestInstaller(t *testing.T) {
	...
	t.Run("aws", func(t *testing.T) {
		run(context.Background(), t, cloudcontrolv1beta1.ProviderAws, []SkrStatusTestCase{
			...
			{"awswebaclstatement.cloud-resources.kyma-project.io", true, "InstallerManifest", KindFormCrd, []string{"Creating"}},
			...
			{"awswebacl.cloud-resources.kyma-project.io", true, "InstallerManifest", KindFormBusola, []string{"Creating"}},
		})
	})
